	...
	<div class="container-fluid">
		<div class="card ">
			<div class="card-header">
				<h3 class="card-title">{{ trans('cancer_type.create_cancer_type')}}</h3>
		  	...
		  	<!-- /.card-header -->
		  	<!-- form start -->
			{!! Form::open(['url' => 'admin/cancer-type', 'class' =>'', 'id'=>'create-cancer-type-form', 'autocomplete' => 'off']) !!}	
...
<script type="text/javascript">
	jQuery(document).ready(function($) { 
		...
		$("#create-cancer-type-form").validate({
